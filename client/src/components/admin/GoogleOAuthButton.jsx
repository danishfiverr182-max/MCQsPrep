// Google OAuth is redirect-based: clicking this button does a full-page
// navigation to the backend's /auth/google route never a fetch/axios call.
// The browser leaves the SPA entirely, Google handles consent, and the
// backend callback redirects back into the app once it's done.
...
export default function GoogleOAuthButton() {
  function handleClick() {
    window.location.href = `${API_TARGET}${ADMIN_PATH}/auth/google`;
  }
