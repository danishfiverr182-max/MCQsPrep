...
import AddNonVerbalSectionPage from "./pages/admin/AddNonVerbalSectionPage";
    ...
    children: [
      ...
      // ── Protected admin routes ─────────────────────────────────────
      {
        ...
        children: [
          ...
          { path: "/admin/dashboard/category/:slug/test/:testId/add-nonverbal",         element: <AddNonVerbalSectionPage /> },
