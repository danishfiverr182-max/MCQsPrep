/**
 * VerbalSectionPage.jsx  (Part 4 Prompt 10)
 *
 ...
 *
 * Route: /admin/dashboard/category/:slug/test/:testId/add-verbal
 */
...
function VerbalSectionPageInner() {
  ...
  const {
    ...
    createEmptyMcq,
    isMcqComplete,
    successToast: "Verbal section saved. Non-Verbal section is now available.",
  });
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-extrabold text-black">Verbal Section</h1>
        ...
        <div className="flex flex-col items-end gap-2">
          <div className="flex items-center gap-3">
            ...
            >
              ...
              {isFinalSaving ? "Saving…" : "Save Verbal Section"}
            </button>
          </div>
      ...
      <StepCard
        ...
        description="How many questions should this verbal section contain?"
      >
...
export default function VerbalSectionPage() {
  return (
    <AdminErrorBoundary>
      <VerbalSectionPageInner />
    </AdminErrorBoundary>
  );
}