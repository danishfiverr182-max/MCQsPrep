/**
 * AcademicSectionPage.jsx  (Part 4 Prompt 10)
 *
 * Prompt 10 additions over Prompt 06:
 ...
 *
 * Route: /admin/dashboard/category/:slug/test/:testId/add-academic
 */
...
function AcademicSectionPageInner() {
  ...
  const {
    ...
    createEmptyMcq,
    isMcqComplete,
    successToast: "Test published successfully! Students can now access it.",
  });
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-extrabold text-black">Academic Section</h1>
        ...
        <div className="flex flex-col items-end gap-2">
          <div className="flex items-center gap-3">
            ...
            >
              ...
              {isFinalSaving ? "Saving…" : "Save Academic Section & Publish Test"}
            </button>
          </div>
      ...
      {/* ── No-sharing info banner ───────────────────────────── */}
      <div className="flex items-start gap-3 bg-blue-400/10 border border-blue-400/20 rounded-xl px-4 py-3">
        <InfoIcon />
        <p className="text-sm text-blue-200">
          Academic MCQs are unique to <span className="font-semibold text-txt-primary">{categoryName}</span>.
          They are not shared with other categories.
        </p>
      </div>
      ...
      <StepCard
        ...
        description="How many questions should this academic section contain?"
      >
        ...
        <div className="mt-4 pt-4 border-t border-border/60">
          <p className="text-xs text-txt-muted mb-2">
            Or skip the manual steps entirely   upload a JSON file and the MCQ count and containers will be created automatically.
          </p>
